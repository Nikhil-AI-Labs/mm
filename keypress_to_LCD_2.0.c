 ...
 *
 * This code takes the user's preferred 'goto' structure but
...
int main(void)
{
    ...
    // *FIX: Set PA8-PA11 as PULL-DOWN (10)*
    // Your old code had 0x00550000 (pull-up), which was wrong.
    // 0x00AA0000 is (10) for PA8, PA9, PA10, PA11.
...
jump:
    ...
    // This part is essential. It waits until you let go of the key.
    ...
    // This loop waits for a new press to happen.
    while(1)
    {
    ...
    for(j = 0; j < 4; j++)
    {
        // *FIX: Correct 32-bit BSRR values*
    ...
    // --- 3e. Encode Key ---
    // *FIX: Correctly find row_index from rowval*
